...
Cross-agent context for `agent-engineering-skills`. Read by Codex, Cursor,
Cline, OpenCode, and other agents that follow the AGENTS.md convention.
Claude Code reads `CLAUDE.md` and Gemini CLI reads `GEMINI.md` for the
same purpose.
...
- Updating documentation: link affected paths and explain the gap closed.
